 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="privacyscan" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "privacyscan";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "privacyscan") + "_chat_session";
