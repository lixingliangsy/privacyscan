...
import { trackCheckoutCta } from '../lib/analytics'
        ...
        <a
          ...
          onClick={() =>
            trackCheckoutCta({
              ...
              value: Math.round(PRODUCT.priceMonthly * 0.7 * 100) / 100,
            })
          }
          className="inline-block bg-brand text-white font-semibold px-8 py-4 rounded-xl hover:opacity-90"
        >
          {`Lock early-bird pricing — $${PRODUCT.priceMonthly}/mo`}
        </a>
        <p className="text-sm text-gray-500 mt-3">30% off your first month. Cancel anytime.</p>
      </div>
