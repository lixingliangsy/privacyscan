      ...
      <main className="min-h-screen bg-slate-50 text-slate-900">
        <div className="max-w-xl mx-auto px-6 py-16">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 mt-6">
            <div className="text-sm font-bold mb-2">Run history &amp; export</div>
            <p className="text-sm text-slate-600 mb-3">
              Every workflow run is saved server-side with its runId, step, and ruleset version. Export your
              history for audit or hand-off.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href="/api/runs?export=json" className="px-4 py-2 rounded-full border border-slate-200 font-bold text-sm">
                Export runs (JSON)
              </a>
              <a href="/api/runs?export=csv" className="px-4 py-2 rounded-full border border-slate-200 font-bold text-sm">
                Export runs (CSV)
              </a>
            </div>
          </div>
